import { AfterViewInit, Component, ModelSignal, OnInit, OutputEmitterRef, Signal, model, output, viewChild } from '@angular/core';
...
export class AddTicketComponent implements AfterViewInit {
  ...
  ngAfterViewInit(): void {
    ...
    setTimeout(() => this.form().setValue({ title: this.ticket()?.title, request: this.ticket()?.request }));
  }
