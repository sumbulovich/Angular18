...
@Component({
  selector: 'app-task',
  standalone: true,
  imports: [MatCardModule, MatButtonModule, MatTooltipModule, EllipsisTooltipDirective, DatePipe, MatTooltipModule, MatSelectModule, MatFormFieldModule, JsonPipe],
  templateUrl: './task.component.html',
  styleUrl: './task.component.scss',
})
export class TaskComponent {
  authUser: InputSignal<Partial<AuthUser> | undefined> = input<Partial<AuthUser>>()
